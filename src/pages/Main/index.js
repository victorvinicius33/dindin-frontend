        ...
        <div>
            ...
            <div className='main-home-container'>
                ...
                <div className='main-home'>
                    <div className='div-filter'>
                        <span
                            ...
                            onClick={lidarComMostrarFiltros}
                        >
                ...
                <div className='resumo-container'>
                    ...
                    <button onClick={() => setMostrarAddRegistro(true)}>Adicionar Registro</button>
                    {mostrarAddRegistro && <AdicionarRegistro setMostrarAddRegistro={setMostrarAddRegistro} categorias={categorias} />}
                </div>
            </div>
        </div>
    );
